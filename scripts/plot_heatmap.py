...
import copy
tasks = np.load('/home/chenjy/OmniDrones/scripts/outputs/v1_6_cl_emptybuffer_from_heightbound0_3_threshold_1toinf/03-30_17-53/wandb/run-20240330_175303-f3mpf9ez/files/tasks/tasks_839.npy')
num_drone = 4
num_target = 1
